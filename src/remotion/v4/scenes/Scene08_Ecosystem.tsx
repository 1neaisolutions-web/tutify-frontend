...
export const SCENE08_DURATION = 540
...
const CYCLE_SLOT = 38
const CYCLE_ENTER = 14
const CYCLE_EXIT = 12
const CYCLE_END = CYCLE_START + CYCLE_SLOT * 4
const DIAGRAM_START = 228
const MERGE_START = 400
const MERGE_END = 500
const CAPTION_START = 258
