...
export const HUB_FOCUS_MICRO = 78
export const CLICK_AT = 116
const CLICK_END = 128
export const COURSE_ENTER = 136
const LESSON_START = 176
const FRAMES_PER_STEP = 36
export const QUIZ_START = LESSON_START + DEMO_LESSON_STEPS.length * FRAMES_PER_STEP + 12
export const Q_SELECT_GAP = 16
const Q_SCROLL_STEP = 168
export const QUIZ_SUBMIT =
  QUIZ_START + DEMO_COURSE.quizQuestions.length * Q_SELECT_GAP + 10
const QUIZ_RESULTS = QUIZ_SUBMIT + 8
export const CERT_START = QUIZ_RESULTS + 12
const CERT_HOLD = 48
