  ...
  return (
    <div className="min-h-[calc(100vh-65px)] w-full bg-white dark:bg-gray-950">
      <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-800">
        <h1 className="text-lg font-semibold text-gray-900 dark:text-gray-100">{t('studentPanel.progress.title')}</h1>
        <p className="text-sm text-gray-600 dark:text-gray-300">{t('studentPanel.progress.subtitle')}</p>
      </div>

      <div className="px-6 py-6 max-w-5xl space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 p-4">
            <p className="text-xs text-gray-500">{t('studentPanel.progress.stats.quizAverage')}</p>
            <p className="mt-1 text-2xl font-semibold text-gray-900 dark:text-gray-100">{overall.avg}%</p>
          </div>
          <div className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 p-4">
            <p className="text-xs text-gray-500">{t('studentPanel.progress.stats.assignments')}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {demoSubjects.map((s) => (
            ...
            >
              ...
              <p className="mt-1 text-sm text-gray-600 dark:text-gray-300">{t('studentPanel.common.quizAvg', { pct: s.quizAvg })}</p>
