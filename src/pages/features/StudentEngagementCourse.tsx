        ...
        <div className="max-w-2xl w-full">
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 text-center">
            <div className="mb-6">
              ...
              <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">{t('studentEngagementCourse.congratulations')}</h1>
              <p className="text-lg text-gray-600">{t('studentEngagementCourse.youVeCompletedTheCourse')}</p>
            </div>
            ...
            <div className="border-2 border-purple-200 rounded-2xl p-8 mb-6 bg-gradient-to-br from-purple-50 to-pink-50">
              ...
              <div className="mt-6 pt-6 border-t border-purple-200">
                <p className="text-sm text-gray-600 mb-2">{t('studentEngagementCourse.certificateOfCompletion')}</p>
                <p className="text-lg font-semibold text-gray-900">{t('studentEngagementCourse.thisCertifiesThatYouHaveSuccessfullyCompleted')}</p>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              >
                <FileText className="w-4 h-4" />{t('studentEngagementCourse.downloadCertificate')}</button>
              <button
              ...
              >{t('studentEngagementCourse.backToLearningHub')}</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-6">
        <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-2xl font-bold text-gray-900">{t('studentEngagementCourse.courseAssessment')}</h2>
              <p className="text-sm text-gray-600 mt-1">{t('studentEngagementCourse.testYourUnderstandingOfStudentEngagementStrategies')}</p>
            </div>
            <button
            ...
            <div className="mt-6 p-6 rounded-2xl bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200">
              <div className="text-center">
                ...
                {passed ? (
                  ...
                  >
                    <Award className="w-4 h-4" />{t('studentEngagementCourse.viewCertificate')}</button>
                ) : (
                  <div className="flex gap-3 justify-center">
                    ...
                    >{t('studentEngagementCourse.reviewCourse')}</button>
                    <button
                      onClick={() => {
                        setQuizAnswers({})
                        setQuizSubmitted(false)
                    ...
                    >{t('studentEngagementCourse.retakeQuiz')}</button>
                  </div>
                )}
              </div>
            </div>
          ...
          {!quizSubmitted && (
            <div className="mt-6 flex justify-end">
              ...
              >{t('studentEngagementCourse.submitAssessment')}<ArrowRight className="w-4 h-4" />
              </button>
            </div>
          )}
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm sticky top-6">
            <h3 className="text-sm font-semibold uppercase tracking-wide text-gray-600 mb-4">{t('studentEngagementCourse.courseContent')}</h3>
            <div className="space-y-2">
        ...
        <div className="lg:col-span-3">
          <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm">
                  ...
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="bg-white rounded-lg p-4 border border-purple-200">
                        <p className="text-sm font-semibold text-gray-700 mb-2">{t('studentEngagementCourse.tips')}</p>
            ...
            <div className="flex items-center justify-between pt-6 border-t border-gray-200">
              ...
              >
                <ArrowLeft className="w-4 h-4" />{t('studentEngagementCourse.previous')}</button>
          ...
          <div className="mt-6 bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl border border-purple-200 p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
              <Target className="w-5 h-5 text-purple-600" />{t('studentEngagementCourse.learningObjectives')}</h3>
