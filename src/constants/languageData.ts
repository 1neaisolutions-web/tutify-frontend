...
/** Fallback when API is loading or unavailable — mirrors backend WORLD_LANGUAGES. */
export const FALLBACK_LANGUAGE_LIST: LanguageOption[] = [
...
export const DEFAULT_LANGUAGE: LanguageOption = FALLBACK_LANGUAGE_LIST[0]
